...
const compararCasillas =()=>{
    vacio = []
        if(arregloSelecciones[0].emoji == arregloSelecciones[1].emoji && arregloSelecciones[2].emoji == arregloSelecciones[1].emoji&& arregloSelecciones[0].emoji == arregloSelecciones[2].emoji&&arregloSelecciones[0] != arregloSelecciones[1]){
            alert("Bien, ganaste")
